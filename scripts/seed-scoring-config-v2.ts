...
async function seedScoringConfigV2() {
  ...
  const scoringConfig = {
    categories: {
      ...
      '4': {
        label: 'Complexity',
        max: 14,
        options: { standard_non_custom: 14, minor_custom: 9, complex_install: 4 },
      ...
      '5': {
        ...
        max: 14,
        options: { fast_decision: 14, average_negotiation: 9, high_sensitivity: 3 },
      ...
      '6': {
        ...
        max: 9,
        options: { sole_decision_maker: 9, small_group: 6, multilayer_board: 2 },
  ...
  await db
    ...
    .values({ versionLabel: 'v2-2026-06-08', isActive: true, config: scoringConfig })
    .onConflictDoUpdate({
