...
export type AuditEntityType = 'user' | 'access' | 'lead' | 'quote' | 'work_order' | 'work_order_item' | 'scoring' | 'pricing'
...
const ENTITY_TYPES: AuditEntityType[] = ['user', 'access', 'lead', 'quote', 'work_order', 'work_order_item', 'scoring', 'pricing']
